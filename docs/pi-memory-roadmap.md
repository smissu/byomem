...
- [Sprint 42] sprint-42-file-search-line-ranges.md — scanner-derived file-search source line ranges exposed through BM25, semantic/hybrid, CLI, and Pi tool results
- [Sprint 43] sprint-43-file-search-async-scan-jobs.md — runtime-local async scan jobs for Pi direct tools, with synchronous scan compatibility preserved and durable queue/lease work deferred
