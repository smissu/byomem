...
- [Sprint 1 — Memory Foundation](./sprint-1-memory-foundation.md)
- [Sprint 2 — Retrieval Policy MVP](./sprint-2-retrieval-policy-mvp.md)
...
- [Sprint 33 — File Search Scanner Status and Progress](./sprint-33-file-search-scanner-status-progress.md)
