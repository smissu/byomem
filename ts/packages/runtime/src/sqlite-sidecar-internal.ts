...
export interface SqliteSidecarOwner {
...
export function openSqliteSidecarBundle(options: SqliteSidecarOptions): { sidecar: SqliteSidecar; mutator: SqliteSidecarMutator } {
...
export function openSqliteSidecarInternal(options: SqliteSidecarOptions): { sidecar: SqliteSidecar; mutator: SqliteSidecarMutator } {
  return openSqliteSidecarBundle(options);
}
